...
SRC_URI="http://download.zarafa.com/community/final/7.0/${PV}-32752/sourcecode/zcp-${PV}.tar.gz"
#SRC_URI="http://download.zarafa.com/community/beta/7.0/${PV}beta1-32585/sourcecode/zcp-${PV}.tar.gz"
