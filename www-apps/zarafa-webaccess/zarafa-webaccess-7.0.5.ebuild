...
SRC_URI="http://download.zarafa.com/community/final/7.0/${PV}-31880/sourcecode/zcp-${PV}.tar.gz"
#SRC_URI="http://download.zarafa.com/community/beta/7.0/${PV}beta2-31131/sourcecode/zcp-${PV}.tar.gz"
