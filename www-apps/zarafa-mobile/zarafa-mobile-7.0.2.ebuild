...
SRC_URI="http://download.zarafa.com/community/final/7.0/${PV}-29470/sourcecode/zcp-${PV}.tar.gz"
#SRC_URI="http://download.zarafa.com/community/beta/7.0/${PV}beta1-29238/sourcecode/zcp-${PV}.tar.gz"
