...
SRC_URI="https://stash.kopano.io/rest/archive/latest/projects/KWA/repos/${PLUGIN_NAME}/archive?at=refs%2Ftags%2F${PLUGIN_SRC_URI_TAG}&prefix=${P}/plugins/${PLUGIN_NAME}&format=tar.gz -> ${P}.tar.gz
