...
'github.com/gopcua/opcua v0.1.12/go.mod'
...
'github.com/Shopify/sarama v1.27.1/go.mod'
...
src_compile() {
	...
	go build -ldflags "${GOLDFLAGS}" ./cmd/telegraf || die "go build failed"
	go install -ldflags "-w -s ${GOLDFLAGS}" ./cmd/telegraf || die "go install failed"
}
