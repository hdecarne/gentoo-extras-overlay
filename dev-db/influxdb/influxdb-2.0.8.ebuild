...
'github.com/influxdata/flux v0.124.0/go.mod'
...
'github.com/influxdata/influx-cli/v2 v2.1.0-rc1.0.20210721210341-bfd929f4449e/go.mod'
...
src_prepare() {
	eapply "${FILESDIR}/${PN}2-build-r2.patch"
	default
}
