...
SRC_URI="http://download.zarafa.com/community/${ZARAFA_RELEASE}/${ZARAFA_VERSION}/${ZARAFA_VERSION}${ZARAFA_VERSION_MINOR}${ZARAFA_BUILD}/sourcode/zarafa-${ZARAFA_VERSION}${ZARAFA_VERSION_MINOR}%20beta%202.tar.gz -> ${P}.tar.gz"
...
#	epatch "${FILESDIR}/zcp-python-daemon.patch"
}
