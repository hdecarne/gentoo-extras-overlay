...
ZARAFA_VERSION="7.2"
ZARAFA_VERSION_MINOR=".1"
ZARAFA_BUILD="-51838"

SRC_URI="https://download.zarafa.com/community/${ZARAFA_RELEASE}/${ZARAFA_VERSION}/${ZARAFA_VERSION}${ZARAFA_VERSION_MINOR}${ZARAFA_BUILD}/sourcecode/zarafa-${ZARAFA_VERSION}${ZARAFA_VERSION_MINOR}-51847.tar.gz -> ${P}.tar.gz"
